...
1. Generates a realistic random Indian user using your own knowledge of common Indian names across regions:
    ...
    - Email: derived from the name with a random 2-3 digit number suffix(e.g. rahul.sharma@gmail.com)
    - Password: 'password123" hashed with wekzeug's generate_password_hash
